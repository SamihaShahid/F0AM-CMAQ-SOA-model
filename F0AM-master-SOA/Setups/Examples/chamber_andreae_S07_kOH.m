...
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/andreae_S07_kOH/conc.xlsx');

time_data = num2cell(S.Time);
time_data=cell2table(time_data,"VariableNames",["t"]);
writetable(time_data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/andreae_S07_kOH/t.xlsx');

data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/andreae_S07_kOH/rnames.xlsx');

data = num2cell(S.Chem.Rates);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/andreae_S07_kOH/rates.xlsx');

data = num2cell(S.Chem.f);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/andreae_S07_kOH/f.xlsx');

data = num2cell(S.Chem.k);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/andreae_S07_kOH/k.xlsx');

data = num2cell(S.Chem.iG);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/andreae_S07_kOH/G.xlsx');
