...
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP2_SOA_TOLRO2_adj_JPHEN/conc.xlsx');

time_data = num2cell(S.Time);
time_data=cell2table(time_data,"VariableNames",["t"]);
writetable(time_data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP2_SOA_TOLRO2_adj_JPHEN/t.xlsx');

data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP2_SOA_TOLRO2_adj_JPHEN/rnames.xlsx');

data = num2cell(S.Chem.Rates);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP2_SOA_TOLRO2_adj_JPHEN/rates.xlsx');

data = num2cell(S.Chem.f);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP2_SOA_TOLRO2_adj_JPHEN/f.xlsx');

data = num2cell(S.Chem.k);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP2_SOA_TOLRO2_adj_JPHEN/k.xlsx');

data = num2cell(S.Chem.iG);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP2_SOA_TOLRO2_adj_JPHEN/iG.xlsx');
