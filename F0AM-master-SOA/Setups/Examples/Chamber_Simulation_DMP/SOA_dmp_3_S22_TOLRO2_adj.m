...
% writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/conc.xlsx');
% 
% time_data = num2cell(S.Time);
% time_data=cell2table(time_data,"VariableNames",["t"]);
% writetable(time_data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/t.xlsx');
% 
% data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
% writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/rnames.xlsx');
% 
% data = num2cell(S.Chem.Rates);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/rates.xlsx');
% 
% data = num2cell(S.Chem.f);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/f.xlsx');
% 
% data = num2cell(S.Chem.k);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/k.xlsx');
% 
% data = num2cell(S.Chem.iG);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/iG.xlsx');

data = num2cell(S.dcaer);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/Chamber_Simulations/24DMP3_SOA_TOLRO2_adj_S22/soa_2.xlsx');
