...
%   names               conc(ppb)               HoldMe    
    ...
    'AACID'            DAQ.CH3CO2H(1)./0.66           0;... %acetic acid, inlet factor 0.66%
...
ChemFiles = {...
    'SAPRC18_k(Met)';
    'SAPRC18_FZS_2_Jvalues(Met)'; %Jmethod flag of 0 specifies "MCM" J-value method.
    'SAPRC18_AllRxns';
    };
...
writetable(data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/conc.xlsx');

time_data = num2cell(S.Time);
time_data=cell2table(time_data,"VariableNames",["t"]);
writetable(time_data, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/t.xlsx');

rnames = num2cell(S.Chem.Rnames);
rnames=cell2table(rnames);
writetable(rnames, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/rnames.xlsx');

rate = num2cell(S.Chem.Rates);
rate = cell2table(rate);
writetable(rate, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/rates.xlsx');

ff = num2cell(S.Chem.f);
ff = cell2table(ff);
writetable(ff, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/f.xlsx');

kk = num2cell(S.Chem.k);
kk = cell2table(kk);
writetable(kk, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/k.xlsx');

gg = num2cell(S.Chem.iG);
gg = cell2table(gg);
writetable(gg, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/iG.xlsx');

cnames = num2cell(S.Cnames);
cnames = cell2table(cnames);
writetable(cnames, '/Users/samiha/Desktop/oxy_aro_chem/SIM_2_S18_STD/cnames.xlsx');
