...
data=readtable('/Users/samiha/Desktop/NMOG_paper_v2/Data/VOC_profile/Andreae19_tmf_S07.xlsx');
...
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S07_wkOH/conc.xlsx');

time_data = num2cell(S.Time);
time_data=cell2table(time_data,"VariableNames",["t"]);
writetable(time_data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S07_wkOH/t.xlsx');

data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S07_wkOH/rnames.xlsx');

data = num2cell(S.Chem.Rates);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S07_wkOH/rates.xlsx');

data = num2cell(S.Chem.f);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S07_wkOH/f.xlsx');

data = num2cell(S.Chem.k);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S07_wkOH/k.xlsx');

data = num2cell(S.Chem.iG);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S07_wkOH/G.xlsx');
