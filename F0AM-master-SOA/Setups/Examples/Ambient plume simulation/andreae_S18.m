...
data=readtable('/Users/samiha/Desktop/NMOG_paper_v2/Data/VOC_profile/andreae19_tmf_S18B.xlsx');
...
ChemFiles = {...
    'SAPRC18_k(Met)';
    'SAPRC18_FZS_2_Jvalues(Met)'; %Jmethod flag of 1 specifies using "BottomUp" J-value method.
    'SAPRC18_AllRxns';
    %'aerosol_precursor_rxns_w_params_n';
    };
...
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S18/conc.xlsx');

time_data = num2cell(S.Time);
time_data=cell2table(time_data,"VariableNames",["t"]);
writetable(time_data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S18/t.xlsx');

data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S18/rnames.xlsx');

data = num2cell(S.Chem.Rates);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S18/rates.xlsx');

data = num2cell(S.Chem.f);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S18/f.xlsx');

data = num2cell(S.Chem.k);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S18/k.xlsx');

data = num2cell(S.Chem.iG);
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/andreae19_S18/G.xlsx');
