...
%}
data=readtable('/Users/samiha/Desktop/NMOG_paper_v2/Data/VOC_profile/epa_tmf_S07_TERP.xlsx');
...
ChemFiles = {...
    ...
    'SAPRC07B_AllRxns_soa_ee_terp';
    'aerosol_precursor_rxns_w_params_epa_terp';
    };
...
data = cell2table(data);
writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/SOA_model/epa_S07_kOH_wSOA_TERP/soa.xlsx');
