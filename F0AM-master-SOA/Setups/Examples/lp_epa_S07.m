...
% writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/epa_S07/conc.xlsx');
% 
% time_data = num2cell(S.Time);
% time_data=cell2table(time_data,"VariableNames",["t"]);
% writetable(time_data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/epa_S07/t.xlsx');
% 
% data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/epa_S07/rnames.xlsx');
% 
% data = num2cell(S.Chem.Rates);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/epa_S07/rates.xlsx');
% 
% data = num2cell(S.Chem.f);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/epa_S07/f.xlsx');
% 
% data = num2cell(S.Chem.k);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/epa_S07/k.xlsx');
% 
% data = num2cell(S.Chem.iG);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper_v2/Data/F0AM_sim_result/epa_S07/G.xlsx');
