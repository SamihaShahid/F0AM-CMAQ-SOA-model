...
ModelOptions.IntTime       = (3*3600)/stepSize;
...
%writetable(data, '/Users/samiha/Desktop/desktop_v1/SOA model/Input/verify_calc_lim_conc.xlsx');

%time_data = num2cell(S.Time);
%time_data=cell2table(time_data,"VariableNames",["t"]);
%writetable(time_data, '/Users/samiha/Desktop/desktop_v1/SOA model/Input/verify_calc_lim_time.xlsx');
