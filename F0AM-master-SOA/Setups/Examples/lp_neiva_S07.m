...
stepSize=15;
Met = {...
    'P'             ones(stepSize,1)*998.4149;... %Pressure, mbar
    'T'             ones(stepSize,1)*300;...    %Temperature, K
    'RH'            ones(stepSize,1)*56;...    %Relative Humidity, percent    
    'kdil'          kdil;...    %dilution, /s
%     'tgauss'        316; %alternative Gaussian dilution initial timescale
    'SZA'           ones(stepSize,1)*34.8648;... %solar zenith angle
    'J4'            ones(stepSize,1)*0.0071;... %NO2 photolysis frequency
...
data=readtable('/Users/samiha/Desktop/NMOG_paper_v2/Data/VOC_profile/neiva_tmf_S07_v2.xlsx');
...
ModelOptions.IntTime = (60*60)/stepSize;       %integration time for each step, seconds
...
% writetable(data, '/Users/samiha/Desktop/NMOG_paper/Data/F0AM_sim_result/neiva_S07/conc.xlsx');
% 
% time_data = num2cell(S.Time);
% time_data=cell2table(time_data,"VariableNames",["t"]);
% writetable(time_data, '/Users/samiha/Desktop/NMOG_paper/Data/F0AM_sim_result/neiva_S07/t.xlsx');
% 
% data = cell2table(S.Chem.Rnames, "VariableNames",["Rxn"]);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper/Data/F0AM_sim_result/neiva_S07/rnames.xlsx');
% 
% data = num2cell(S.Chem.Rates);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper/Data/F0AM_sim_result/neiva_S07/rates.xlsx');
% 
% data = num2cell(S.Chem.f);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper/Data/F0AM_sim_result/neiva_S07/f.xlsx');
% 
% data = num2cell(S.Chem.k);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper/Data/F0AM_sim_result/neiva_S07/k.xlsx');
% 
% data = num2cell(S.Chem.iG);
% data = cell2table(data);
% writetable(data, '/Users/samiha/Desktop/NMOG_paper/Data/F0AM_sim_result/neiva_S07/G.xlsx');
