...
i=i+1;
Rnames{i} = 'TOLRO2 + NO = NO + 0.0259*SVAVB2 + 0.0243*SVAVB3 + 0.07614*SVAVB4';
k(:,i) = 2.55e-12.*exp(379.932./T);
Gstr{i,1} = 'TOLRO2'; Gstr{i,2} = 'NO';
fTOLRO2(i)=fTOLRO2(i)-1; fNO(i)=fNO(i)-1; fNO(i)=fNO(i)+1; fSVAVB2(i)=fSVAVB2(i)+0.0259; fSVAVB3(i)=fSVAVB3(i)+0.0243; fSVAVB3(i)=fSVAVB3(i)+0.07614;

i=i+1;
Rnames{i} = 'TOLRO2 + HO2 = HO2 + 0.2268*SVAVB1';
k(:,i) = 1.49e-11;
Gstr{i,1} = 'TOLRO2'; Gstr{i,2} = 'NO';
fTOLRO2(i)=fTOLRO2(i)-1; fHO2(i)=fHO2(i)-1; fHO2(i)=fHO2(i)+1; fSVAVB1(i)=fSVAVB1(i)+0.2268;
