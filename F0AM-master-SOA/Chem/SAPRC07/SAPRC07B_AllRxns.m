...
'RO2CRO2XC'; 'RO2XCHO2'; 'HO2MEO2'; 'RO2XCNO';'CRESRO2'; };
...
i=i+1;
Rnames{i} = ' CRES + OH = 0.2*BZO + 0.8*RO2C + 0.8*xHO2 + 0.8*yR6OOH + 0.25*xMGLY +  5.05*XC + 0.8*CRESRO2';
k(:,i) =  1.70e-12.*exp(950./ T);
Gstr{i,1} = 'CRES'; Gstr{i,2} = 'OH'; 
fCRES(i)=fCRES(i)-1; fOH(i)=fOH(i)-1; fBZO(i)=fBZO(i)+0.2; fRO2C(i)=fRO2C(i)+0.8; fxHO2(i)=fxHO2(i)+0.8; fyR6OOH(i)=fyR6OOH(i)+0.8; fxMGLY(i)=fxMGLY(i)+0.25; fXC(i)=fXC(i)+5.05; fCRESRO2(i)=fCRESRO2(i)+0.8; 
