...
SpeciesToAdd = {...
'PHEN'; 'PHEN_A1'; 'PHEN_P1'; 'SVPHE'; 'HCHDO'; 'PHEN_P2'; 'HCHDO_P1'; 'SVPHE_P1'; 'CRES'; 'CRES_P1';'AFG4A';'TOLRO2';};

AddSpecies

i=i+1; % TOLRO2 RXN COUNTER assigned
Rnames{i} = 'PHEN + OH = .95*PHEN_A1 + .05*BZO + .00*HO2 + TOLRO2';
k(:,i) = 4.70e-13.*(T./300).^0.00.*exp(1219.807./T);
Gstr{i,1} = 'PHEN'; Gstr{i,2} = 'OH';
fPHEN(i)=fPHEN(i)-1; fOH(i)=fOH(i)-1; fPHEN_A1(i)=fPHEN_A1(i)+0.95; fBZO(i)=fBZO(i)+.05; fHO2(i)=fHO2(i)+0.00; fTOLRO2(i)=fTOLRO2(i)+1;
